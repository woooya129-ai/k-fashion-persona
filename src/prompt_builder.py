...
#
# Korean prompt-injection phrases should reflect realistic user input.
# The previous Korean phrases were copied from a wishlist; real Korean concept
# inputs do not contain them verbatim.
# Replaced with the actually-occurring forms used by attackers in Korean
# product descriptions. Tests now use natural Korean inputs (not the literal
