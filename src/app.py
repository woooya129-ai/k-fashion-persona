...
from src.ui.rendering import (
    ...
    render_secret_field_header,
    render_secret_password_input,
...
def start_screening(
    ...
    if _has_active_job_in_progress():
        lang = "KR" if bool(st.session_state.get("kfps_lang_is_kor", True)) else "EN"
        st.warning(ui_text(lang, "job_already_running"))
        return
