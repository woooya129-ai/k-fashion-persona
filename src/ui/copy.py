...
UI_COPY: dict[str, dict[str, str]] = {
    "KR": {
        ...
        "run_mode": "실행 방식",
        "mode_preview": "미리보기(5명)",
        "mode_quick": "FAST",
        "mode_balanced": "BALANCE",
        "mode_deep": "HIGH",
        "mode_max": "MAX",
        "mode_preview_help": "5명 패널. 빠르게 형식만 미리 확인할 때.",
        ...
        "setup_readiness_model": "모델",
        "setup_readiness_api_key": "API KEY",
        "setup_readiness_dataset": "데이터셋",
        "setup_readiness_hint": "사이드바에서 입력하세요",
        ...
        "gate_api_key": "API KEY 입력",
        "gate_category": "카테고리 선택",
        "gate_description": "컨셉 설명 입력",
        "gate_dataset": "데이터셋 준비",
        "gate_cost_confirm": "비용·시간 확인",
        "gate_injection_confirm": "감지 문구 확인",
        "gate_checklist_header": "실행 전 확인 사항",
        "gate_checklist_blocked": "아래 항목을 완료하면 실행할 수 있어요.",
        "gate_checklist_ready": "모든 준비가 완료됐어요. 실행할 수 있어요.",
        "gate_check_ok": "✓",
        "gate_check_missing": "✗",
        "run_button": "ENTER",
        "run_panel_body": (
    ...
    "EN": {
        ...
        "run_mode": "Run mode",
        "mode_preview": "Preview (5)",
        "mode_quick": "FAST",
        "mode_balanced": "BALANCE",
        "mode_deep": "HIGH",
        "mode_max": "MAX",
        "mode_preview_help": "5-person panel. Quick format check.",
        ...
        "setup_readiness_model": "Model",
        "setup_readiness_api_key": "API KEY",
        "setup_readiness_dataset": "Dataset",
        "setup_readiness_hint": "Set this in the sidebar",
        ...
        "gate_api_key": "Enter API KEY",
        "gate_category": "Choose a category",
        "gate_description": "Describe the concept",
        "gate_dataset": "Prepare dataset",
        "gate_cost_confirm": "Confirm cost/time",
        "gate_injection_confirm": "Confirm flagged text",
        "gate_checklist_header": "Before you run",
        "gate_checklist_blocked": "Complete the items below to enable the run.",
        "gate_checklist_ready": "Everything is ready. You can run now.",
        "gate_check_ok": "✓",
        "gate_check_missing": "✗",
        "run_button": "ENTER",
        "run_panel_body": (
