...
class TestComputePriceContextHash:
    def test_deterministic(self):
        h1 = compute_price_context_hash("kostat", "2025_annual", 141_000, "kostat_2025_annual_v1")
        h2 = compute_price_context_hash("kostat", "2025_annual", 141_000, "kostat_2025_annual_v1")
        assert h1 == h2

    def test_different_source(self):
        h1 = compute_price_context_hash("kostat", "2025_annual", 141_000, "v1")
        h2 = compute_price_context_hash("other", "2025_annual", 141_000, "v1")
        assert h1 != h2

    def test_different_period(self):
        h1 = compute_price_context_hash("kostat", "2025_annual", 141_000, "v1")
        h2 = compute_price_context_hash("kostat", "2025_q4", 141_000, "v1")
        assert h1 != h2

    def test_different_denominator(self):
        h1 = compute_price_context_hash("kostat", "2025_annual", 141_000, "v1")
        h2 = compute_price_context_hash("kostat", "2025_annual", 142_000, "v1")
        assert h1 != h2
